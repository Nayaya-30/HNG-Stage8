...
// Removed unused Id import to satisfy lint rules
...
export const startTour = mutation({
    ...
    handler: async (_ctx, args) => {
        ...
        const sessionId = await _ctx.db.insert('sessions', {
            tourId: args.tourId,
            userId: args.userId,
            startedAt: now,
...
export const completeTour = mutation({
    ...
    handler: async (_ctx, args) => {
        ...
        await _ctx.db.patch(args.sessionId, {
            completedAt: now,
            status: 'completed'
        });
...
export const getTourAnalytics = query({
    ...
    handler: async (_ctx, _args) => {
        // Placeholder implementation; remove unused variables to satisfy lint
